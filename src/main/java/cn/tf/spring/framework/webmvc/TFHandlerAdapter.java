...
public class TFHandlerAdapter {
    ...
    public TFModelAndView handle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception{
        TFHandlerMapping handlerMapping = (TFHandlerMapping)handler;
        ...
        boolean isModelAndView = handlerMapping.getMethod().getReturnType() == TFModelAndView.class;
        if(isModelAndView){
            return (TFModelAndView) result;
        }
        return null;
    }
